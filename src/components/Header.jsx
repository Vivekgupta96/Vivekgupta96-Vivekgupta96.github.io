    ...
    <>
      <VStack style={{ backgroundColor: "#E0E4FF", position: "fixed", top: "0px", width: "100%" }} display={{ "2xl": "flex", xl: "flex", lg: "flex", md: "flex", sm: "none", base: "none" }} padding={3} boxShadow={"rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;"}>
        <Flex w="100%" justifyContent={'space-between'} alignItems={'center'}>
          <Heading ml="5" size="md" fontWeight="bold" color="blue.700">Vivek Gupta</Heading>
          <Flex id='nav-menu' width={["70%", "70%", "65%", "60%", "50%"]} justifyContent={"space-between"} alignItems={'center'} color="blue.700" fontWeight="bold">
            ...
            <Link Link className="nav-link projects"
              ...
              <Link Link className="nav-link contacts"
                            to="contacts"
                            smooth={true}
                            duration={200}
                            >
                                      <Text _hover={{ cursor: "pointer" }} id="contacts1" >CONTACT</Text>
                            </Link>


            <a href="https://drive.google.com/file/d/1rg-plHT55XtpuRBsZ2A_gfUU-YUwIRwR/view?usp=sharing" target='_black'><Button id="resume" _hover={{ cursor: "pointer" }} as={'b'}>
              <Flex alignItems={'center'} gap="1">RESUME <FaArrowAltCircleDown /></Flex></Button></a>
      ...
      <VStack style={{ backgroundColor: "#E0E4FF", position: "fixed", top: "0px", width: "100%" }} display={{ "2xl": "none", xl: "none", lg: "none", md: "none", sm: "flex", base: "flex" }} padding={3} boxShadow={"rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;"}>
        <Flex w="100%" justifyContent={'space-between'} alignItems={'center'}>
          <Heading ml="5" size="md" fontWeight="bold" color="purple.500">Vivek Gupta</Heading>
      ...
      >
        ...
        <DrawerContent size={"xs"}>
          ...
          <Box p="40px" color="#805AD5">
            ...
            <hr />
            <a href="https://drive.google.com/file/d/1rg-plHT55XtpuRBsZ2A_gfUU-YUwIRwR/view?usp=sharing" target='_black'><Box id="resume" m="5px" pl="10px"><Flex _hover={{ cursor: "pointer" }} alignItems={'center'} gap="1"><Text as="b"
            >RESUME</Text> <FaArrowAltCircleDown /></Flex></Box></a>
            <hr />
          </Box>
          <DrawerBody>
          </DrawerBody>
